        ...
        try:
            ...
            for line in lines:
                ...
                if go_match:
                    ...
                    print(f"     📞 {current_script} → {target} (GO)")
                ...
                if sub_match:
                    ...
                    self.dependencies[current_script].add(target)
                    print(f"     📞 {current_script} → {target} (SUB_SCRIPT)")
                ...
                if mission_match:
                    ...
                    self.dependencies[current_script].add(target)
                    print(f"     🚀 {current_script} → {target} (LAUNCH_MISSION)")
...
<body>
    ...
    <script type="text/javascript">
        ...
        nodes.forEach(function(node) {{
            ...
            node.size = Math.max(10, Math.min(30, node.id.length * 2));
        }});
        ...
        network.on("hoverNode", function (params) {{
            ...
            // Mostra tooltip (implementazione semplice)
