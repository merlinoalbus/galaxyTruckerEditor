export const interactiveMapStyles = {
  container: "w-full h-full relative bg-gradient-radial from-slate-800 to-slate-900 rounded-lg overflow-hidden",
  header: "p-4 bg-slate-800 bg-opacity-80 border-b border-gray-600 flex justify-between items-center",
  ...
  viewport: "w-full h-[600px] relative",
  loading: {
