...
const TOOL_CATEGORIES_DEFINITION = (t: any): ToolCategory[] => [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'addparttoship', name: 'ADDPARTTOSHIP', icon: '🔧', blockType: 'ADDPARTTOSHIP', description: t('visualFlowEditor.tools.addPartToShip.description'), implemented: false, inProgress: true },
      { id: 'addparttoasideslot', name: 'ADDPARTTOASIDESLOT', icon: '📦', blockType: 'ADDPARTTOASIDESLOT', description: t('visualFlowEditor.tools.addPartToAsideSlot.description'), implemented: false, inProgress: true },
      ...
      { id: 'setflightdeckpreparationscript', name: 'SETFLIGHTDECKPREPARATIONSCRIPT', icon: '🛩️', blockType: 'SETFLIGHTDECKPREPARATIONSCRIPT', description: t('visualFlowEditor.tools.setFlightDeckPreparationScript.description'), implemented: false, inProgress: true },
