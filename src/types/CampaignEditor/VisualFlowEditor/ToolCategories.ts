...
const TOOL_CATEGORIES_DEFINITION = (t: any): ToolCategory[] => [
  {
    ...
    tools: [
      ...
      { id: 'changechar', name: 'CHANGECHAR', icon: '🎭', blockType: 'CHANGECHAR', description: t('visualFlowEditor.tools.changeChar.description'), implemented: false, inProgress: true },
      ...
      { id: 'hidechar', name: 'HIDECHAR', icon: '👻', blockType: 'HIDECHAR', description: t('visualFlowEditor.tools.hideChar.description'), implemented: false, inProgress: true },
