...
export const SetToBlock: React.FC<SetToBlockProps> = ({
  block,
  onUpdate,
  onRemove,
  onDragStart,
    ...
    return (
      <div className="space-y-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <input
              ...
              placeholder={t('visualFlowEditor.blocks.setTo.valuePlaceholder')}
        ...
        <div className="text-xs text-gray-500">
          {t('visualFlowEditor.blocks.setTo.description')}
        </div>
      </div>
    );
  };
      ...
      <div className="flex items-center gap-2 w-full">
        {variable ? (
          ...
          <span className="text-red-400 text-sm">
            {t('visualFlowEditor.blocks.setTo.noVariable')}
          </span>
        )}
      </div>
    );
