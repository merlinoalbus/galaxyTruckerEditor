...
export const AlienHelpScriptBlock: React.FC<Props> = ({ block, updateBlock, availableScripts = [] }) => {
  ...
  return (
    <div className="vfe-block vfe-help">
      <div className="vfe-block-header">
        <div className="vfe-title">{(t as any)('visualFlowEditor.command.alienHelpScript')}</div>
